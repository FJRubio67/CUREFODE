---
title: "`PTCMGH`: Overall Survival Analysis"
...
The following R code illustrates how to analyse overall survival in this data set using the `PTCMGH` R package.
...
dfc <- data.frame(agent = df$agent, length = df$length, menopause = df$menopause,
                  ...
                  os_time = df$os_time/12, os_event = df$os_event)
